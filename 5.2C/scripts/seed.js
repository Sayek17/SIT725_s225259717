...
// The five books from Task 5.1P, with an AUD price added for this task.
// This is the only place the sample data exists. The application code has none.
const sampleData = [
  {
    id: 'b1',
...
// Clears the collection and inserts the sample data once, using the same
// connection style as the app.
(async () => {
  try {
    ...
    console.log('Seeded ' + sampleData.length + ' books.');
  } catch (error) {
