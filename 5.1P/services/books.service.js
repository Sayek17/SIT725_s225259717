// The catalog data for this task. The books are held in memory here rather
// than in a database, and this is the only file that knows what the data
// looks like. A route or a controller never touches the array directly.
const books = [
  {
    id: 'b1',
...
// Hands back the whole catalog.
const getAllBooks = () => books;

// Finds one book by its id string. Returns undefined when nothing matches.
